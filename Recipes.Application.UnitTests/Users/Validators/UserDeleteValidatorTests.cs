...
public class UserDeleteValidatorTests(UserDeleteValidator validator) : UserDeleteValidatorFixture
{
    [Theory]
    [InlineData("1BB5204C-4FB0-4079-9DB4-2FC7436853B9")]
    [InlineData("E8432368-9894-46F1-B857-64432A00AB59")]
    public void ProperUserDeleteData_Should_BeValid(string userId)
    {
    ...
    [Fact]
    public void UserDeleteData_Should_BeInvalid()
    {
        var dto = new UserDeleteDto()
        {
            Id = Guid.Empty
